      ...
      <div className="mx-auto container flex h-full  items-center justify-between w-full px-3 md:px-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-semibold text-gray-800">
            Dev<span className="text-sm font-semibold text-[#D91B7E]">
          Stack
          </span>
          </h2>
        ...
        <div className="md:flex items-center gap-7 hidden">
          ...
          <a href="#" className="text-[11px] text-gray-500 hover:text-[#D91B7E]">
            Technologies
          </a>
        ...
        <div className="flex items-center gap-4">
          <button
            className="text-[11px] text-gray-600 border-2 hover:text-white border-gray-100 px-4 py-2 rounded-full hover:bg-pink-500 cursor-pointer"
          >
            Sign In
          </button>
